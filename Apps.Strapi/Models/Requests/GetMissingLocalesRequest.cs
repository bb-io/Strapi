...
{
    [Display("Content type ID (singular)", Description = "The content type of the document. This should be the singular form of the content type, e.g., 'article' for 'articles'.")]
