...
{
    [Display("Content type ID (singular)", Description = "The content type of the document. If you are using strapi v4 this should be the singular form of the content type, e.g., 'article' for 'articles'.")]
