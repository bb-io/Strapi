...
public class JsonToHtmlConverterTests : TestBase
{
    ...
    public async Task ConvertToHtml_ValidJson_ReturnsExpectedHtml()
    {
        ...
        // Act
        var html = JsonToHtmlConverter.ConvertToHtml(_testJson, contentId, "animals");
        ...
        Assert.AreEqual("animals", contentTypeMeta.GetAttributeValue("content", ""), "Content type should be 'entry'");
    ...
    public void ConvertToHtml_InvalidJson_ThrowsException()
    {
        ...
        Assert.ThrowsException<ArgumentException>(() => 
            JsonToHtmlConverter.ConvertToHtml(invalidJson, contentId, "animals"),
